package sg.edu.rp.c346.id20039583.demodatabasecrud;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public long insertNote(String noteContent) {
        ...
        long result = db.insert(TABLE_NOTE, null, values); //get a number which is the record id
        db.close();
    ...
    public int updateNote(Note data){
        ...
        int result = db.update(TABLE_NOTE, values, condition, args); //gets number representing no. of rows affected in table
        db.close();
        return result;
    }
    ...
    public int deleteNote(int id){
        ...
        int result = db.delete(TABLE_NOTE, condition, args); //get a no. representing no. of rows affected in table
        db.close();
        return result;
    }
